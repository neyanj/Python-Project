...
def calculate_age(birthday):
    ...
    # a bool representing if today's day, or month precedes the birthday, or month
...
if __name__ == "__main__":
    ...
    # asking user to enter birth year, birth month, and birthdate
    ...
    dateOfBirth: date = date(birthYear, birthMonth, birthDay)
